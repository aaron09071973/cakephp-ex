        <div class="row">
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>Ejemplo de Aplicación en OpenSift</h2>
     
              <h2>Deploying code changes</h2>
                <p>
                  El codigo fuente de esta aplicación esta disponible en  <a href="https://www.github.com/sclorg/cakephp-ex">OpenShift GitHub repository</a>.
